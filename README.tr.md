...
- Karıştır / Önceki / Oynat-Duraklat / Sonraki / Tekrarla düğmeleri (karıştır ve tekrarla, aktif oynatıcı bunları SMTC üzerinden sunmuyorsa soluklaştırılır)
...
- Medya tuşuna basıldığında **ve** bir uygulama kendi penceresinden parça değiştirdiğinde ya da oynat/duraklat'a tıkladığında açılır (Ayarlar'dan kapatılabilir)
- Sağ tıklayınca menü açılan tepsi simgesi (Ayarlar, Başlangıçta çalıştır, Çıkış)
- Özel çizilmiş Ayarlar penceresi: 9 sabitleme konumu, özel X/Y, kenar boşluğu ayarı, görünür süre ayarı, kompakt mod, "parça değiştiğinde göster" anahtarı ve başlangıçta çalıştırma anahtarı
- **Kompakt mod** — yalnızca kapak + başlık + sanatçı içeren, kontrolsüz 280×64'lük mini kart
- Tek örnek — exe'yi yeniden çalıştırmak ikinci kopya oluşturmaz
